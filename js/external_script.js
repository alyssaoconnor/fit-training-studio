...
function showCard(object)
	{
		...
		switch(card)
		{
			...
			case "bitcoin":
			    ...
			    break;
			default:
			    document.getElementById("bitcoin").style.border="1px solid #000";
				document.getElementById("master").style.border="1px solid #000";
				document.getElementById("americanExpress").style.border="1px solid #000";
				document.getElementById("visa").style.border="1px solid #000";
				document.getElementById("paypal").style.border="1px solid #000";
